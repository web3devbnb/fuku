    ...
    <div class="view-home narrow-container">
        ...
        <div class="row row-2-cols-lg no-collapse equal-height">
            <div class="col">
                <router-link :to="{name: 'blocks'}" class="no-effect">
                    <f-card class="home-block block1" hover>
                        ...
                        <h2 class="h3">{{ $t('view_home.blocks') }} <icon data="@/assets/svg/angle-right.svg"
                                color="#999"></icon>
                        </h2>
                        <div class="num">
                            <animated-number :value="chainState.blocks | formatHexToInt" :formatValue="formatNum"
            ...
            <div class="col">
                <router-link :to="{name: 'staking'}" class="no-effect">
                    <f-card class="home-block block2" hover>
                        ...
                        <h2 class="h3">{{ $t('view_home.validators') }} <icon data="@/assets/svg/angle-right.svg"
                                color="#999"></icon>
                        </h2>
                        <div class="num">
                            <animated-number :value="chainState.validators | formatHexToInt" :formatValue="formatNum"
                                :duration="numAnimationDuration" />
                        </div>
                    </f-card>
                </router-link>
            ...
            <div class="col">
                <f-card class="home-block block3">
                    ...
                    <div class="num">
                        <animated-number :value="chainState.accounts | formatHexToInt" :formatValue="formatNum"
                            :duration="numAnimationDuration" />
                    </div>
                </f-card>
            </div>
            <div class="col">
                <router-link :to="{name: 'transactions'}" class="no-effect">
                    <f-card class="home-block  block4" hover>
                        ...
                        <h2 class="h3">{{ $t('view_home.transactions') }} <icon data="@/assets/svg/angle-right.svg"
                                color="#999"></icon>
                        </h2>
                        <div class="num">
                            <animated-number :value="chainState.transactions | formatHexToInt" :formatValue="formatNum"
                                :duration="numAnimationDuration" />
                        </div>
                    </f-card>
                </router-link>
        ...
        <div class="row equal-height mat-5">
            <div class="col">
                <f-card class="half-padding">
                    <center>
                        <h2 class="h3 n1">Latest <span>Blocks</span></h2>
                    </center>
        ...
        <div class="row equal-height mat-5">
            <div class="col">
                <f-card class="half-padding">
                    <center>
                        <h2 class="h3 n1">Latest <span>Transactions</span></h2>
                    </center>
                    <div class="home-table-in">
        ...
        <div class="row equal-height mat-5 l1 l3">
            <div class="col">
                <f-card class="half-padding">
                    <center>
                        <h2 class="h3 n1" id="txv">Daily <span>Transactions</span></h2>
                    </center>
                    <div class="home-table-in">
...
.view-home {
    ...
    .f-search-box {
        background: linear-gradient(to right, #ff1515, #fbe1e0);
        padding: 1px;
        border-radius: 28px;
    }
    ...
    .block1 {
        background: linear-gradient(to right, #541275, #a81f7e) !important;
    }

    .block2 {
        background: linear-gradient(to right, #2d1976, #3842cb) !important;
    }

    .block3 {
        background: linear-gradient(to right, #5e6195, #a09dd5) !important;
    }

    .block4 {
        background: linear-gradient(to right, #8927c9, #551c95) !important;
    }
